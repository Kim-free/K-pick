...
public class MissionSuggestionController {
    ...
    @PostMapping
    public ResponseEntity<MissionSuggestionResponse> createMissionSuggestion(@RequestBody CreateMissionSuggestionRequest request) {
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(missionSuggestionService.createMissionSuggestion(request));
    }
}
